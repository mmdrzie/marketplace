...
# 3. Update listings section
# Replace the old listings container with glass-3d
...
# 4. Update How It Works step icon
...
new_stats_open = '''<div className="glass-3d">
            <div className="glass-3d__inner">
              <div className="glass-3d__spotlight"></div>
              <div className="glass-3d__content">'''

content = content.replace(old_stats_open, new_stats_open)
...
new_cta_open = '''<div className="glass-3d">
            <div className="glass-3d__inner">
              <div className="glass-3d__spotlight"></div>
              <div className="glass-3d__content relative p-12 md:p-20 text-center">
                {/* animated glow orb */}'''

content = content.replace(old_cta_open, new_cta_open)
