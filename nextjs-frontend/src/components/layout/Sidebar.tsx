...
const DASHBOARD_SUB_ITEMS: DashboardSubItem[] = [
  { href: '/dashboard', label: 'پیشخوان', renderIcon: (cn) => <Svg className={cn}><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></Svg> },
  { href: '/dashboard/listings', label: 'آگهی‌های من', renderIcon: (cn) => <Svg className={cn}><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></Svg> },
  { href: '/dashboard/listings/new', label: 'ثبت آگهی جدید', renderIcon: (cn) => <Svg className={cn}><path d="M12 5v14M5 12h14" /></Svg> },
  { href: '/dashboard/messages', label: 'پیام‌ها', renderIcon: (cn) => <Svg className={cn}><path d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></Svg> },
  { href: '/dashboard/favorites', label: 'علاقه‌مندی‌ها', renderIcon: (cn) => <Svg className={cn}><path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></Svg> },
  { href: '/dashboard/deals', label: 'معاملات', renderIcon: (cn) => <Svg className={cn}><path d="M9 14l6-6m-5.5.5h.01M14.5 9.5h.01M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></Svg> },
  { href: '/dashboard/notifications', label: 'اعلان‌ها', renderIcon: (cn) => <Svg className={cn}><path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></Svg> },
  { href: '/dashboard/analytics', label: 'آمار', renderIcon: (cn) => <Svg className={cn}><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></Svg> },
  { href: '/dashboard/wallet', label: 'کیف پول', renderIcon: (cn) => <Svg className={cn}><path d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></Svg> },
  { href: '/dashboard/settings', label: 'تنظیمات', renderIcon: (cn) => <Svg className={cn}><path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" /></Svg> },
];
          ...
          <nav className="flex-1 overflow-y-auto p-3 space-y-1">
            ...
            <div className="pt-3">
              <div className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${
                ...
                <span className={`shrink-0 ${isDashboardActive ? 'text-primary' : 'text-muted-foreground'}`}>
                  <Svg className="h-4 w-4"><path d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></Svg>
                </span>
                داشبورد
              </div>
              <div className="mr-3 pr-3 border-r border-border/50 space-y-0.5 mt-1">
                {DASHBOARD_SUB_ITEMS.map((sub) => {
                  const subActive = pathname === sub.href || (sub.href !== '/dashboard' && pathname.startsWith(sub.href + '/'));
                  return (
                    <Link
                      key={sub.href}
                      href={sub.href}
                    ...
                    >
                      <span className={`shrink-0 ${subActive ? 'text-primary' : 'text-muted-foreground group-hover:text-foreground'}`}>
                        {sub.renderIcon('h-3.5 w-3.5')}
                      </span>
                      {sub.label}
                    </Link>
                  );
