          ...
          <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[12vh] p-4">
            ...
            >
              ...
              <div className="p-4 border-b border-border/30 bg-surface-2/40 flex items-center gap-3">
                ...
                <button
                  onClick={() => setUserMenuOpen(false)}
                  className="flex items-center justify-center w-8 h-8 rounded-lg hover:bg-surface-3 transition-colors text-muted-foreground"
                  aria-label="بستن"
                >
              ...
              <div className="p-3 space-y-0.5">
                <Link href="/dashboard/messages" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                ...
                <Link href="/dashboard/notifications" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                  <SvgIcon className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary">
                ...
                <Link href="/dashboard" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                  <SvgIcon className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary">
                ...
                {user?.role === 'store' && (
                  <Link href="/store/inventory" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                    <SvgIcon className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary">
                ...
                {(user?.role === 'dealer' || user?.role === 'agency') && (
                  <Link href="/dealer/listings" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                    <SvgIcon className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary">
                ...
                {user?.role === 'admin' && (
                  <Link href="/admin" onClick={() => setUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-surface-2/50 transition-all group">
                    <SvgIcon className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-primary">
              ...
              <div className="p-3 pt-1 border-t border-border/30">
                <button
