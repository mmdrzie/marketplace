    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="absolute inset-0 bg-overlay/90 backdrop-blur-xl"
          onClick={onClose}
        />
        <motion.div
        ...
        >
          ...
          <button onClick={onClose} className="absolute -top-3 -right-3 w-9 h-9 rounded-full bg-surface-1 flex items-center justify-center border border-border/60 text-muted-foreground hover:text-foreground transition-colors shadow-xl">
