  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden px-4">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] rounded-full blur-[150px] motion-safe:animate-pulse" style={{ backgroundColor: 'color-mix(in srgb, var(--color-accent-blue) 10%, transparent)' }}></div>
        ...
        <div className="absolute inset-0 bg-grid-pattern opacity-[0.14] dark:opacity-[0.09]"></div>
      </div>
